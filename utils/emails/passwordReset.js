    ...
    html: `
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Hello, ${user.name}</p>
                    <p>Enter this token to complete the reset:<b> ${user.resetPasswordToken} <b> </p>
                    
                    <p>Please use this token as a parameter in reset password route . If you did not request a password reset, please ignore this email.</p>
                </div>
            </div>
        </body>
        </html>
